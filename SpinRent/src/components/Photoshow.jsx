    ...
    return(
        <div>
            ...
            <div className="max-w-2xl flex flex-col">
                <button onClick={()=>onchange(false)} className="p-3 left-1/2 self-start mx-8 bg-gray-800 text-white flex gap-2 rounded-xl mb-4">
                ...
                <div className="grid gap-8 px-8 max-w-2xl">
                    {
                        // eslint-disable-next-line react/prop-types
