    ...
    return(
        ...
        <div className="w-full max-w-xl">
                        ...
                        <div id="features" className="w-full max-w-xl grid grid-cols-2 gap-2 md:grid-cols-3 mt-2">
                            ...
                            <label className="flex border p-4 text-base gap-1 rounded-2xl items-center">
                                <input name='rearcam' onChange={cbcheck} type="checkbox" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <label className="flex border p-4 text-base gap-1 rounded-2xl items-center">
                                <input name='infotainment' onChange={cbcheck} type="checkbox" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <label className="flex border p-4 text-base gap-1 rounded-2xl items-center">
                                <input name='electric' onChange={cbcheck} type="checkbox" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <label className="flex border p-4 text-base gap-1 rounded-2xl items-center">
                                <input name='abs' onChange={cbcheck} type="checkbox" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <label className="flex border p-4 text-base gap-1 rounded-2xl items-center">
                                <input name='cruisecontrol' onChange={cbcheck} type="checkbox" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                            ...
                            <label className="flex border p-4 text-base gap-1 rounded-2xl items-center">
                                <input name='auto' onChange={cbcheck} type="checkbox" />
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
